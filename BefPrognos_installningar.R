...
# för att testa att köra befolkningsprognoserna kör raden nedan
# diag_befolkningsprognos(region_vekt = "20", bara_lan = FALSE, JmfrFleraPrognoser = FALSE, jmfrtid = 10, dataetiketter = FALSE)
...
url_tabeller <- c("https://api.scb.se/OV0104/v1/doris/sv/ssd/BE/BE0401/BE0401A/BefProgOsiktRegN",
